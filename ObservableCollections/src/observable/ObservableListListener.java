...
public interface ObservableListListener<E> extends EventListener {
	/**
	 * Notification than a property of an element in this list has changed. Not all
	 * {@code ObservableLists} support this notification. Only observable lists that
	 * return {@code true} from {@code supportsElementPropertyChanged} send this
	 * notification.
	 *
